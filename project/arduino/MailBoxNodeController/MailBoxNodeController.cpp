...
#else
const char gJSONthings1[] PROGMEM ="{\"Id\":\"0001\",\"Type\":\"MailBox\"    ,\"SType\":\"Sensor\"  ,\"VType\": \"String\",\"VMin\" : \"Empty\" ,\"VMax\" : \"Mail\" }";
const char JSONstatus1[] PROGMEM ="{\"Id\":\"0001\",\"Type\":\"MailBox\"   ,\"Value\":\"";
#endif
...
void SendJSONstatusEvent(WiFiClient localclient)
{
    ...
    if(HomeNode.proximity <= 50)  // on mails
    { 
      gsBufferWiFi+="Mail";
    }
    else
